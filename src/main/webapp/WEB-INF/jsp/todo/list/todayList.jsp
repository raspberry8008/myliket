	...
	<div id="content">
	 ...
	 <c:import url="../../include/topbar.jsp"/> 
		...
		<div class="container-fluid col-6">
         ...
         <!-- Page Heading -->
         <div class="py-5">
		  <h2 class="mb-2 text-center text-gray-800">TODO리킷 - 오늘 할일 조회</h2>
		   <p class="text-center">오늘 할일을 확인하세요!</p>
		 </div>
			...
			<c:if test="${fail != null }">
				<div class="text-center">
					<div class="alert alert-info" role="alert"><c:out value="${fail}"/>
						<a href="<c:url value='/todo/insert/todo'/>" class="btn btn-info shadow-sm">일정 추가</a> 
					</div>	 
				</div>
			</c:if>
