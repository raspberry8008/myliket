	...
	<div id="content">
	 ...
	 <c:import url="../../include/topbar.jsp"/> 
		...
		<div class="container-fluid col-6">
         ...
         <!-- Page Heading -->
         <div class="py-5">
		  <h2 class="mb-2 text-center text-gray-800">TODO리킷 -TODOLIST</h2>
		   <p class="text-center">TODO리킷(카테고리)에 등록된 일정을 확인하세요!</p>
		 </div>
			...
			<c:if test="${success != null }">				
				<div class="table-responsive">
	         		<table class="table table-hover">
						<thead>
							<tr>
								<th class="text-center" colspan="5"><c:out value="${TodocateVO.todocateName}"/></th>
							</tr>
						</thead>
						<tbody>
