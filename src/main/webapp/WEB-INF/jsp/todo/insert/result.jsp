	 ...
	 <c:import url="../../include/topbar.jsp"/> 
		...
		<div class="container-fluid col-6">
			...
			<c:if test="${fail != null }">
			 ...
			 <!-- Page Heading -->
	        <div class="py-5">
			 <h2 class="mb-2 text-center text-gray-800">TODO리킷 - 할일 추가 실패</h2>
			</div>
			...
			<div class="text-center">
				...
				<div class="alert alert-light" role="alert">할일 추가를 다시 시도해 주시기 바랍니다.</div>
			...
			<c:if test="${success != null }">
			 ...
			 <!-- Page Heading -->
	        <div class="py-5">
			 <h2 class="mb-2 text-center text-gray-800">TODO리킷 - 할일 추가 완료</h2>
			 <hr>
			</div>
			...
			<div class="text-center">
				...
				<div class="alert alert-light" role="alert">추가된 할일을 관리해보세요!</div>
				<a href="<c:url value='/home'/>"
					 class="btn btn-info col-lg-12 shadow-sm">홈으로</a> 
			</div>
			</c:if>
