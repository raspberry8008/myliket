	 ...
	 <c:import url="../../include/topbar.jsp"/> 
		...
		<div class="container-fluid col-6">
			...
			<c:if test="${fail != null }">
			 ...
			 <!-- Page Heading -->
	        <div class="py-5">
			 <h2 class="mb-2 text-center text-gray-800">TODO리킷 - 카테고리 삭제 실패</h2>
			</div>
			...
			<div class="text-center">
				...
				<div class="alert alert-light" role="alert">할일 삭제를 다시 시도해 주시기 바랍니다.</div>
			...
			<c:if test="${success != null }">
			 ...
			 <!-- Page Heading -->
	        <div class="py-5">
			 <h2 class="mb-2 text-center text-gray-800">TODO리킷 - 카테고리 삭제 완료</h2>
			 <hr>
			</div>
